...
def main():
    ...
    readme = ["# Listicle Swipe File\n",
              "Full-page clones of listicles. Each folder under `swipes/` contains a self-contained `index.html` (images/CSS embedded) plus `source.txt` with the original URL.\n",
